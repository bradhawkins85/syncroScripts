...
Out-File -FilePath "C:\Temp\Powershell\$Name.ps1" -Force -InputObject $command
Out-File -FilePath "C:\Temp\Powershell\$Name-Encoded.txt" -Force -InputObject $outcommand
